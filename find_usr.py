...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("ChatApp", "ChatApp"))
        self.pushButton.setText(_translate("Find user by ID", "Find user by ID"))
        self.pushButton_2.setText(_translate("Go back", "Go back"))
